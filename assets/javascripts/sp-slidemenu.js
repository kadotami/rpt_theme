...
SpSlidemenu.prototype.setElement = function(options) {
    ...
    _this.header = document.querySelector(options.header);
};
...
SpSlidemenu.prototype.slideOpen = function(event) {
    ...
    if (_this.useCssAnimation) {
        ...
        animate(_this.header, _this.direction, toX, ANIME_SPEED.slider);
        setStyles(_this.slidemenu, {
            visibility: 'visible'
        });
    }
...
SpSlidemenu.prototype.slideClose = function(event) {
    ...
    if (_this.useCssAnimation) {
        ...
        animate(_this.header, _this.direction, 0, ANIME_SPEED.slider);
        setStyles(_this.slidemenu, {
            zIndex: '-1'
        });
    }
